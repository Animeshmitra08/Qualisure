  ...
  return (
    <>
        ...
        <div className="container mx-auto px-2 my-2">
            ...
            <div className="max-w-sm mx-auto mt-4 pt-2 bg-white border flex flex-col items-center border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <img className="rounded-t-lg w-1/3" src="./assets/images.png" alt="image" />
